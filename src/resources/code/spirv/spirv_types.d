module resources.code.spirv.spirv_types;

enum SpvSourceLanguage : uint {
    Unknown         = 0,
    ESSL            = 1,
    GLSL            = 2,
    OpenCL_C        = 3,
...
enum SpvSelectionControl : uint {
    Flatten = 0,
    DontFlatten = 1,
    Max = 0x7fffffff,
}

enum SpvLoopControl : uint {
    Unroll = 0,
    DontUnroll = 1,
